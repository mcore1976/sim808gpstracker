                ...
                if (  ( gpsdataavailable == 1) && (continousgps == 255) )
                   {
                    ...
                    if ( (strncmp(latitudegpsold, latitudegps, (sizeof(latitudegps)-4) )!=0 ) ||  (strncmp(longtitudegpsold, longtitudegps, (sizeof(longtitudegps)-4))!=0 ) ) 
