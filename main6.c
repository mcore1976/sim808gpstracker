                ...
                if (  ( gpsdataavailable == 1) && (continousgps == 255) )
                   {
                    ...
                    // sizeof operator also counts NULL last char of string
                    if ( (strncmp(latitudegpsold, latitudegps, (sizeof(latitudegps)-3) )!=0 ) ||  (strncmp(longtitudegpsold, longtitudegps, (sizeof(longtitudegps)-3))!=0 ) ) 
