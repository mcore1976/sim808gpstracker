 ...
 * this version is for board without SIM808 DTR (SLEEP PIN)  !!!
 * VCC :
...
// for your Mobile Network provider - here are for Everything Everywhere UK
const char SAPBR1[] PROGMEM = {"AT+SAPBR=3,1,\"CONTYPE\",\"GPRS\"\r\n"};  
const char SAPBR2[] PROGMEM = {"AT+SAPBR=3,1,\"APN\",\"everywhere\"\r\n"};    // Put your mobile operator APN name here
const char SAPBR3[] PROGMEM = {"AT+SAPBR=3,1,\"USER\",\"eesecure\"\r\n"};   // Put your mobile operator APN username here
const char SAPBR4[] PROGMEM = {"AT+SAPBR=3,1,\"PWD\",\"secure\"\r\n"};    // Put your mobile operator APN password here 
