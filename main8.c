 ...
 * this version is suitable for the SIM808 boards that DO NOT HAVE DTR, RING  pin exposed
 * but only RXD, TXD, GND pins....
 *  
 * connections to be made :
 * SIM808 RXD to ATMEGA328 TXD PIN #3,
 * SIM808 TXD to ATMEGA328 RXD PIN #2
 * VCC :
 * consult your SIM808 board vendor... ATMEGA328 VCC (PIN #7) must be connected to VCC ~3.3V or  5V 
 * depending on type of TTL LOGIC of SIM808 board
 * if you need 3,3V then you may use 3x 1N4007 diodes in serial to drop voltage from 5V to ~3.3V
 * GND :
 ...
 * GUARD    : enables GUARD MODE - notifies when GPS position changes over SMS, sensivity is 300m but can be changed
                                 ...
                                 if   (is_in_rx_buffer(strupr(smstext), buf) == 1)  
                                     {
                                        ...
                                        // store SMS sender phone to EEPROM memory for further comparision
