...
and use "compileatmegaXX.bat" files for compilaton in the directory where you have downloaded mainX.c files. 
...
You can see how it works here : https://www.youtube.com/watch?v=ZMRz5Emcvew 
