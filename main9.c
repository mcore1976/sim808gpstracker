                                          ...
                                          { // if specified amount of second passed, we need to check 2G network coverage
                                            ...
                                            if ( (accvolt < 775) && (accvolt > 510) )
                                                { 
                                                 ...
                                                 if (accvolt > 775 ) uart_puts_P(CARBATTOVER);
                                                 if ( (accvolt < 510) && (accvolt > 345) ) uart_puts_P(CARBATTUNDER);
                                                 if ( accvolt < 346 )  uart_puts_P(CARBATTDISC);
